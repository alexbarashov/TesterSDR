...
def main():
    ...
    print("2. DONE Add to beacon_tester_web.py after line 33")
    print("3. DONE Initialize in init_sdr_backend() with actual_sample_rate")
    print("4. DONE Write BP signal after NCO in process_samples_realtime()")
    print("5. DONE Extract segments in detect_pulses() by absolute indices")
    print("6. DONE Use get_actual_fs() instead of SAMPLE_RATE_SPS")
