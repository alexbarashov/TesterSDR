@echo off
echo ====================================================
echo COSPAS/SARSAT Beacon Tester DSP2Web - Startup
echo ====================================================
...
REM 3) Запуск веб-клиента
echo Starting web client...
start "Web Client" "C:\Users\alexb\AppData\Local\Programs\Python\Python39\python.exe" "C:\work\TesterSDR\beacon406\beacon_tester_dsp2web.py" --pub tcp://127.0.0.1:8781 --rep tcp://127.0.0.1:8782

REM 4) Пауза для запуска веб-клиента
timeout /t 3 >nul
...
echo Web Client: http://127.0.0.1:8738/
echo ====================================================
